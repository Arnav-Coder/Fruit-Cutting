...
function setup() {
  ...
  knife.setCollider("rectangle",0,0,40,120,30);
...
function draw() {
  ...
  if(gameState===PLAY){
    ...
    //destroy fruit on touching knife  
...
if(gameState == END){
  ...
  textSize(50);
  fill("Black");
  text("Score : "+ score,200,390);
  textSize(25);
  text("Press 'f5' to restart",200,440);
}

if(gameState == forSound){
  textSize(30);
  fill("Red");
  text("Tap on the screen for sounds",200,300)
